...
#            obj = gml.collision_rectangle(curs_obj.position.x, curs_obj.position.y, curs_obj.position.x+15,  curs_obj.position.y+15, "drawn_sprite", 0, false, self) # DY:  instance_position(curs_obj.position.x+8, curs_obj.position.y+12, drawn_sprite)
