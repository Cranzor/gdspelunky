...
func create():
	...
	if (n < 20): sprite_index = "lush_gold"
	elif (n < 30): sprite_index = "lush_gold_big"
		...
		if (randi_range(1,80) == 1): gml.instance_create(position.x+8, position.y+8, Objects.sapphire_big, self)
		elif (randi_range(1,100) == 1): gml.instance_create(position.x+8, position.y+8, Objects.emerald_big, self)
		elif (randi_range(1,120) == 1): gml.instance_create(position.x+8, position.y+8, Objects.ruby_big, self)
