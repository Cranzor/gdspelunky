...
#    n = 160 - str_len
#    n = ceil(n / 2)
#    draw_text.draw_text(n, 32, "PRESS BUTTON FOR")
...
#        draw_text.draw_text(8, 88, "NO GAMEPAD FOUND!")
...
#        n = 160 - str_len
#        n = ceil(n / 2)
#        draw_text.draw_text(n, 40, "START")
...
#        1:  draw_text.draw_text(80, 104, "B1")  
#        2:  draw_text.draw_text(80, 104, "B2")  
#        3:  draw_text.draw_text(80, 104, "B3")  
#        4:  draw_text.draw_text(80, 104, "B4")  
#        5:  draw_text.draw_text(80, 104, "B5")  
#        6:  draw_text.draw_text(80, 104, "B6")  
#        7:  draw_text.draw_text(80, 104, "B7")  
#        8:  draw_text.draw_text(80, 104, "B8")  
#        9:  draw_text.draw_text(80, 104, "B9")  
#        10:  draw_text.draw_text(80, 104, "B10")  
#        -1:  draw_text.draw_text(80, 104, "LT (XB)")  
#        -2:  draw_text.draw_text(80, 104, "RT (XB)")  
#        default:  draw_text.draw_text(80, 104, "B" + str(curr_val))
#    break 
