...
func step():
	...
	type == "rope"):
		...
		if (type == "bomb" and sticky):
			...
			if (abs(x_vel) > 2 or abs(y_vel) > 2 and gml.collision_rectangle(position.x-2, position.y-2, position.x+2,  position.y+2, "enemy", 0, false, self) and enemy_id == 0):
			...
			elif (abs(x_vel) > 2 or abs(y_vel) > 2 and gml.collision_rectangle(position.x-2, position.y-2, position.x+2,  position.y+2, "damsel", 0, false, self) and enemy_id == 0):
			
				enemy_id = gml.collision_rectangle(position.x-2, position.y-2, position.x+2,  position.y+2, "damsel", 0, false, self)
				#/*
				#if (enemy_id.bomb_id):
				#
