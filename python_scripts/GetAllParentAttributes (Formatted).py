...
import_directory = r'C:\Users\Jesse\Desktop\H&C2\programming\Spelunky Godot Porting Scripts\AllParentAttributes\AllParentAttributes.txt'
...
file_path = r'C:\Users\Jesse\Desktop\H&C2\programming\Spelunky Godot Porting Scripts\AllParentAttributes\AllParentAttributesFormatted.txt'


formatted_file_text = handle_file(import_directory)
new_text = re.sub('\(\'(.+)\',', r'\1:', formatted_file_text)
