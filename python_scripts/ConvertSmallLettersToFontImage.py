...
font_files = natsorted(glob(r'C:\Users\Jesse\Desktop\H&C2\programming\Spelunky Godot Porting Scripts\Dump\Sprites\sFontSmall.images\*.png'))
loaded_images = []
...
dump_location = r'C:\Users\Jesse\Desktop\H&C2\programming\Spelunky Godot Porting Scripts\GeneratedFont\SmallFont'
