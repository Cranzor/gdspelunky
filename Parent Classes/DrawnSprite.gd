...
func find_grid_position():
	var grid_position: Vector2
	
	var spacing = Vector2(12, 10)
	
	grid_position.x = get_nearest_multiple(global_position.x, spacing.x * 16)
	grid_position.y = get_nearest_multiple(global_position.y, spacing.y * 16)
	...
	calculate_grid_position(grid_position, spacing)
