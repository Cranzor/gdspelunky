...
#                gold = gml.instance_create(position.x+8+gml.rand(0,4)-gml.rand(0,4), position.y+8+gml.rand(0,4)-gml.rand(0,4), Objects.gold_chunk)
#                gold.x_vel = gml.rand(0,3) - gml.rand(0,3)
#                gold.y_vel = gml.rand(2,4) * 1
        
#            gold = gml.instance_create(position.x+8+gml.rand(0,4)-gml.rand(0,4), position.y+8+gml.rand(0,4)-gml.rand(0,4), Objects.gold_nugget)
#            gold.x_vel = gml.rand(0,3) - gml.rand(0,3)
#            gold.y_vel = gml.rand(2,4) * 1
