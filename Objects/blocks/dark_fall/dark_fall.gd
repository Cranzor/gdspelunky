...
#        obj = gml.instance_create(position.x+randi_range(2,14), position.y+randi_range(2,14), "rubble_dark")
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">viscid_top = 1
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">if Collision.is_collision_character_top(1):

#        time_fall -= 1
#        if (time_fall <= 0): y_acc = grav

#    elif (time_fall < time_fallMax): time_fall += 1

#    if (y_vel > 10): y_vel = 10</argument>
#          </arguments>
#        </action>
#      </actions>
#    </event>
