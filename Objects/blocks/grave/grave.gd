...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">n = randi_range(1,5)
#    match (n)
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">rubble = gml.instance_create(position.x+8+randi_range(0,8)-randi_range(0,8), position.y+8+randi_range(0,8)-randi_range(0,8), "rubble")
...
#    rubble = gml.instance_create(position.x+8+randi_range(0,8)-randi_range(0,8), position.y+8+randi_range(0,8)-randi_range(0,8), "rubbleSmall")
#    rubble.sprite_index = s_rubble_tanSmall</argument>
#          </arguments>
#        </action>
#      </actions>
#    </event>
