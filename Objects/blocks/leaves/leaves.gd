...
#func destroy():
    #    if (sprite_index != "leaves_dead and sprite_index != s_leaves_dead_r):"
...
#        elif (sprite_index == "leaves or sprite_index == s_leaves_dead):"
...
#        elif (sprite_index == "leaves_right or sprite_index == s_leaves_dead_r):"
