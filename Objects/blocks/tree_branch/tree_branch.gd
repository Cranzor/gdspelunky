...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">if (global.cemetary): sprite_index = s_tree_branch_dead_r</argument>
#          </arguments>
#        </action>
#      </actions>
#    </event>
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">if (sprite_index != s_tree_branch_dead_l and sprite_index != s_tree_branch_dead_r):
