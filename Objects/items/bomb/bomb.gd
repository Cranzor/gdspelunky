...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">type = "Bomb"
#    PlatformEngine.make_active()
#    Collision.set_collision_bounds(-4, -4, 4, 4)</argument>
#          </arguments>
#        </action>
#      </actions>
#    </event>
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">if (enemy_id):
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">if (!gml.instance_exists("enemy_id")):
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">if (sprite_index = s_bomb_armed): depth = 49
#    if (sticky): depth = 1
