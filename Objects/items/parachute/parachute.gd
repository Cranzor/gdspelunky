...
#          <arguments>
#            <argument kind="STRING">if (sprite_index == s_para_open): sprite_index = s_parachute</argument>
#          </arguments>
#        </action>
#      </actions>
#    </event>
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">if (other.x_vel > 0 or other.y_vel > 0):
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">if (gml.instance_exists("player1")):
