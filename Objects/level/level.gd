...
#          <arguments>
#            <argument kind="STRING">screen.enabled = true
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING"># DY: sound_stop(snd_music_test2)</argument>
#          </arguments>
#        </action>
#      </actions>
#    </event>
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">if (music_fade and music_fadeTimer < 100):
