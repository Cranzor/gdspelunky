...
#        trophy = gml.instance_create(32, 32, "trophy")
#        if (t_money >= 200000):
    
#            trophy.sprite_index = s_gold_trophy
#            gml.instance_create(32, 48, "x_sun")
    
#        elif (t_money >= 100000):
    
#            trophy.sprite_index = s_silver_trophy
    
#        else:
    
#            trophy.sprite_index = s_bronze_trophy
    


#    if (t_time > 0 and t_time < 960):

#        trophy = gml.instance_create(64, 64, "trophy")
#        if (t_time <= 960):
...
#            trophy.sprite_index = s_gold_trophy
#            gml.instance_create(64, 80, "x_moon")
    


#    if (t_kills >= 80):

#        trophy = gml.instance_create(32, 96, "trophy")
#        if (t_kills >= 120):
    
#            trophy.sprite_index = s_gold_trophy
#            gml.instance_create(32, 112, "x_stars")
...
#        trophy = gml.instance_create(64, 128, "trophy")
#        if (t_saves >= 8):
    
#            trophy.sprite_index = s_gold_trophy
#            gml.instance_create(64, 144, "x_change")
