...
#          <arguments>
#            <argument kind="STRING">sprite_index = s_edit_button</argument>
#          </arguments>
#        </action>
#      </actions>
#    </event>
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">sprite_index = s_edit_button_pressed</argument>
#          </arguments>
#        </action>
#      </actions>
#    </event>
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">if (sprite_index == s_edit_button_pressed):
...
#    sprite_index = s_edit_button</argument>
#          </arguments>
#        </action>
#      </actions>
#    </event>
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">position.x = view_xview[0]+16
