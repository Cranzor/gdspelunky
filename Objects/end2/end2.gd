...
#          <arguments>
#            <argument kind="STRING">player = gml.instance_create(240, 132, "player_sil")
#    # DY: player.x_vel = -6
#    # DY: player.y_vel = -8
#    alarm_1(30)</argument>
#          </arguments>
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">player = gml.instance_create(240, 132, "treasure_sil")
#    # DY: player.x_vel = -6
#    # DY: player.y_vel = -8</argument>
#          </arguments>
#        </action>
#      </actions>
#    </event>
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">gml.instance_create(224+randi_range(0,48), 144+randi_range(0,8), "volcanflame")
#    alarm_2()randi_range(10,20)</argument>
#          </arguments>
#        </action>
#      </actions>
#    </event>
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">alarm_0(50)
#    alarm_2(10) # DY: </argument>
#          </arguments>
#        </action>
#      </actions>
#    </event>
