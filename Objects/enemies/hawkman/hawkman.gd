...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">if (sprite_index == s_hawk_throw_l):

#        status = IDLE
#        sprite_index = s_hawk_left
#    </argument>
#          </arguments>
#        </action>
#      </actions>
...
#        if (x_vel == 0 and hp > 0): sprite_index = s_hawk_stun_l
#        elif (bounced):
    
#            if (y_vel < 0): sprite_index = s_hawk_bounce_l
#            else: sprite_index = s_hawk_fall_l
    
#        else:
    
#            if (abs(x_vel) > 0): sprite_index = s_hawk_die_ll
#            else: sprite_index = s_hawk_die_lr
...
#        if (abs(x_vel) > 0): sprite_index = s_hawk_run_left
#        else: sprite_index = s_hawk_left

#    if (held):

#        if (hp > 0): sprite_index = s_hawk_held_l
#        else: sprite_index = s_hawk_d_held_l
