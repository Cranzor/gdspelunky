...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">if (throw_counter == 0 and status != GRAB and other.active and not other.held):
...
#          <applies_to>.self</applies_to>
#          <arguments>
#            <argument kind="STRING">type = "Monkey"
...
#    if (gml.collision_point(position.x, position.y, "water", 0, 0)): swimming = true</argument>
#          </arguments>
#        </action>
#      </actions>
#    </event>
...
#                # DY:  throw out money
#                global.money -= n
#                obj = gml.instance_create(position.x, position.y, "gold_nugget")
#                with obj
...
#    if (status == HANG): sprite_index = s_monkey_hang_l
#    elif (status == CLIMB or status == GRAB): sprite_index = s_monkey_climb_l
#    elif (not col_bot): sprite_index = s_monkey_jump_l
#    elif (status == WALK): sprite_index = s_monkey_walk_l
#    else: sprite_index = s_monkey_left
